...
const banner = ({purchasedTicket,resolvedTicket}) => {
    return (
        <div className='max-w-[1200px] mx-auto flex justify-between mt-5'>
            ...
            <div className='rounded-[7px] relative px-57 py-23 overflow-hidden bg-gradient-to-r from-[#632EE3] to-[#9F62F2]'>
            ...
            <div className='rounded-[7px] relative px-57 py-23 overflow-hidden bg-gradient-to-r from-[#54CF67] to-[#00827A]'>
                <img src={bg1} className="absolute left-0 top-0" alt="left" />
